...
MEDIA_DIR = Path("media/profesores")
...
async def save_image_profesor(file: UploadFile) -> str:
    ...
    return f"media/profesores/{filename}"  # Ruta relativa para guardar en DB


def delete_image_profesor(image_url: str):
    if image_url:
